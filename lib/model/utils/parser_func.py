...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="whether use strong-weak aug in warm up phase",
        action="store_true",
    )
    parser.add_argument(
        "--mutual_use_SWAug",
        dest="mutual_use_SWAug",
        help="whether use strong-weak aug in mutual learning",
        action="store_true",
    )
    parser.add_argument(
        "--warmup_use_targetlike",
        dest="warmup_use_targetlike",
        help="whether use target-like image in warm up phase",
        action="store_true",
    )
    parser.add_argument(
        "--warmup_use_GPA",
        dest="warmup_use_GPA",
        help="whether use GPA to get aligned source img in warm up phase",
        action="store_true",
    )
    parser.add_argument(
        "--mutual_use_targetlike",
        dest="mutual_use_targetlike",
        help="whether use target-like image in mutual learning phase",
        action="store_true",
    )
    parser.add_argument(
        "--mutual_use_GPA",
        dest="mutual_use_GPA",
        help="whether use GPA-aligned source image in mutual learning phase",
        action="store_true",
    )
    #######################
    #### ST++ setting #####
    ...
    parser.add_argument(
        "--reliable_path",
        dest="reliable_path",
        help="data path of selecting reliable data",
        default='',
        type=str,
    )
    #######################################################
    ...
    parser.add_argument(
        "--unsup_loss_w",
        dest="unsup_loss_weight",
        help="loss weight for unsupervised loss",
        default=1,
        type=int,
    )
    parser.add_argument(
        "--adv_loss_w",
        dest="adv_loss_weight",
        help="loss weight for adv loss",
        default=0.1,
        type=float,
    )
    parser.add_argument(
        "--aut_lr", dest="aut_lr", help="learning rate", default=0.04, type=float
    )
    parser.add_argument(
        "--warmup_epoch",
        dest="warmup_epoch",
        help="num of epoch for warming up",
        default=1,
        type=int,
    )
    parser.add_argument(
        "--mutual_epoch",
        dest="mutual_epoch",
        help="num of epoch for mutual learning",
        default=5,
        type=int,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--unsup",
        dest="enable_unsup",
        help="whether enable unsupervised loss",
        default=True,
        type=bool,
    )
    ############################################################
