...
if __name__ == "__main__":
    ...
    if args.dataset_t == "foggy_cityscape":
        ...
        from lib.model.aut_faster_rcnn.aut_vgg16_multi_level_adv import vgg16
    ...
    exp_setup="xxxx-rerun-mladv-tinycutout-st++warmup-s{}{}_SWAug_{}_mutual-{}{}_SWAug_{}_bs_{}_unsup_loss_w_{}_adv_loss_w_{}_EF_{}_threshold_{}_aut_lr_{}_warmup_epoch_{}_mutual_epoch_{}_ema_weight_{}_lrdc_epoch{}".format(
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        if epoch == warmup_epoch:
            ...
            for step in range(1, iters_per_epoch + 1):
                ...
                print("teacher_fasterRCNN:",teacher_fasterRCNN.training)
                ...
                adv_loss=advloss_s_p + advloss_t_p + advloss_s_mid * 0.15 +advloss_t_mid * 0.15 + advloss_s_image + advloss_t_image + advloss_s_ins * 0.5 + advloss_t_ins * 0.5
